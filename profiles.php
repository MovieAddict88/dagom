...
$sql = "SELECT p.id, p.name, p.created_at, p.type, p.icon_path, 
        ...
        GROUP BY p.id, p.name, p.created_at, p.type, p.icon_path 
        ORDER BY p.name";
$stmt = $pdo->query($sql);
                ...
                <div class="profile-card" data-profile-id="<?php echo $profile['id']; ?>" data-profile-type="<?php echo htmlspecialchars($profile['type']); ?>">
                    ...
                    <div class="profile-card-body">
                        ...
                        <?php if (!empty($profile['promo_names'])) : ?>
                            <p class="profile-promo"><?php echo htmlspecialchars($profile['promo_names']); ?></p>
                        <?php endif; ?>
